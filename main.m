NON_SEIZURE_SET = dlmread('D:\SVM\data/training_set_n.txt')'; % Label = 0
SEIZURE_SET = dlmread('D:\SVM\data/training_set_s.txt')'; % Label = 1
TEST_SET = dlmread('D:\SVM\data/test_set.txt')';
TEST_LABELS = dlmread('D:\SVM\data/test_labels.txt')';
